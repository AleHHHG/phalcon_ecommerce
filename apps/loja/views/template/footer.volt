    ...
    <div class="slider-items-products">
      <div id="brand-logo-slider" class="product-flexslider hidden-buttons">
        <div class="slider-items slider-width-col6"> 
          ...
          <!-- Item -->
          <div class="item"> <a href="#x"><img src="{{this.ecommerce_options.image_path}}/b-logo1.png" alt="Image"></a> </div>
          <!-- End Item --> 
          
          <!-- Item -->
          <div class="item"> <a href="#x"><img src="{{this.ecommerce_options.image_path}}/b-logo2.png" alt="Image"></a> </div>
          <!-- End Item --> 
          
          <!-- Item -->
          <div class="item"> <a href="#x"><img src="{{this.ecommerce_options.image_path}}/b-logo3.png" alt="Image"></a> </div>
          <!-- End Item --> 
          
          <!-- Item -->
          <div class="item"> <a href="#x"><img src="{{this.ecommerce_options.image_path}}/b-logo4.png" alt="Image"></a> </div>
          <!-- End Item --> 
          
          <!-- Item -->
          <div class="item"> <a href="#x"><img src="{{this.ecommerce_options.image_path}}/b-logo5.png" alt="Image"></a> </div>
          <!-- End Item --> 
          
          <!-- Item -->
          <div class="item"> <a href="#x"><img src="{{this.ecommerce_options.image_path}}/b-logo6.png" alt="Image"></a> </div>
          <!-- End Item --> 
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-6">
          <div class="payment-accept"> <img src="{{this.ecommerce_options.image_path}}payment-1.png" alt=""> <img src="{{this.ecommerce_options.image_path}}payment-2.png" alt=""> <img src="{{this.ecommerce_options.image_path}}payment-3.png" alt=""> <img src="{{this.ecommerce_options.image_path}}payment-4.png" alt=""> </div>
        </div>
        <div class="col-xs-12 col-sm-6">
          <div class="social">
            <ul>
