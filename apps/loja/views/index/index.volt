<div id="magik-slideshow" class="magik-slideshow">
	<div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container' >
			{{ helper.banner.getHelper([
				'container_id': 'rev_slider_4',
				'container_class':'rev_slider fullwidthabanner',
				'caption_options': ['TITLE','DESCRIPTION'],
				'title_options' : [
					[
						'class': 'tp-caption sft large_bold_white_25',
						'data-x' : '150',
						'data-y' : '200',
						'data-endspeed':'500',
						'data-speed':'500',
						...
						'class': 'tp-caption sfb large_bold_white_25',
						'data-x' : '150',
						'data-y' : '200',
						'data-endspeed':'500',
						'data-speed':'500',
				...
				'description_options' : [
					[
						'class': 'tp-caption sfl medium_text ',
						'data-x' : '150',
						'data-y' : '280',
						'data-endspeed':'500',
						'data-speed':'500',
						...
						'class': 'tp-caption sft medium_text',
						'data-x' : '150',
						'data-y' : '300',
						'data-endspeed':'500',
						'data-speed':'500',
...
<div class="offer-banner-section">
 	{{ helper.banner.getHelper([
		...
		'slide_item_class':'col over-effect col-lg-4 col-xs-12 col-sm-4 wow bounceInUp animated',
		'caption': false,
		'posicao': 2
	 ])
	}}
		      ...
		      <div id="best-seller-slider" class="product-flexslider hidden-buttons">
		      	<div class="slider-items slider-width-col4"> 
			      	{{ helper.produto.getHelper([
			      		'quantidade_itens':20,
			      		'container_class':'item',
			      		'produto_thumbail_class':'product-image product-display',
			      		'overlay_class':'product-action',
			      		'produto_info_class':'item-info',
			      		'produto_info_titulo':'<div class="%1Ss"><a href="%2Ss">%3Ss</a></div>',
			      		'produto_info_titulo_class':'item-title',
