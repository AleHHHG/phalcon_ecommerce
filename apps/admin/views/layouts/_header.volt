   ...
   <div class='quick-area'>
      ...
      <div class='pull-right'>
         <ul class="info-menu right-links list-inline list-unstyled">
            <li class="profile">
               <a href="#" data-toggle="dropdown" class="toggle">
               <img src="http://cptstatic.s3.amazonaws.com/imagens/enviadas/materias/materia10372/3criacao-de-capivaras-curso-cpt.jpg" alt="user-image" class="img-circle img-inline">
