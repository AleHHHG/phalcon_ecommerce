<div class="page-sidebar ">
   ...
   <div class="page-sidebar-wrapper" id="main-menu-wrapper">
      ...
      <ul class='wraplist'>
         ...
         <li class=""> 
            <?php echo $this->tag->linkTo(array('/admin/categorias', '<i class="fa fa-th"></i>
               <span class="title">Categorias</span>')); ?>
         </li>
        <li class=""> 
            <?php echo $this->tag->linkTo(array('/admin/produtos', '<i class="fa fa-cube"></i>
         ...
         <li class="">
            ...
            <ul class="sub-menu" >
               <li>
                  <?php echo $this->tag->linkTo(array('/admin/loja/geral', 'Geral')); ?>
               </li>
               <li>
                  <?php echo $this->tag->linkTo(array('/admin/loja/produtos', 'Produtos')); ?>
               </li>
               <li>
                  <a href="javascript:;">Design</a>
                  <ul class="sub-menu" >
                     <li><?php echo $this->tag->linkTo(array('/admin/banners', 'Banners')); ?></li>
